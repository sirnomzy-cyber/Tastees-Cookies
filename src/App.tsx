...
const featuredCookies: Cookie[] = [
  {
    ...
    description: "Deep cocoa dough with molten chocolate pockets and a soft, bakery-style finish.",
    price: "$6.50",
    image: "/images/double-chocolate-cookie.png",
  },
  {
    name: "Caramel Crunch",
    description: "Buttery caramel ribbons, golden toffee bits, and a delicate sea salt lift.",
    price: "$6.20",
    image: "/images/caramel-crunch-cookie.png",
  },
  {
    name: "Red Velvet Cookie",
    description: "Velvety red crumb with white chocolate and cream frosting swirls.",
    price: "$6.40",
    image: "/images/red-velvet-cookie.png",
  },
  {
    name: "Peanut Butter Bliss",
    description: "Roasted peanut richness, chewy edges, and a silky peanut butter finish.",
    price: "$6.10",
    image: "/images/peanut-butter-bliss-cookie.png",
  },
  {
    name: "Oreo Cream Cookie",
    description: "Cookies and cream indulgence with a dark cocoa crumble and vanilla center.",
    price: "$6.80",
    image: "/images/oreo-cream-cookie.png",
  },
];
...
const sellers: Seller[] = [
  {
    ...
    description: "Customer favorite with a glossy center and a deep, velvety chocolate aroma.",
    price: "$7.00",
    image: "/images/double-chocolate-cookie.png",
    rating: "4.9",
    label: "Bestseller",
  },
  {
    ...
    description: "Limited release with flaky salt crystals and a caramel pull that photographs beautifully.",
    price: "$7.20",
    image: "/images/caramel-crunch-cookie.png",
    rating: "4.8",
  ...
  {
    name: "Velvet Cloud",
    description: "A plush, bakery-soft cookie with a dessert counter finish and a refined sweetness.",
    price: "$7.10",
    image: "/images/red-velvet-cookie.png",
    rating: "5.0",
    label: "Chef pick",
  ...
  {
    name: "Cocoa Cream Royale",
    description: "An elevated cookies-and-cream build with a luxe vanilla filling and chocolate crumbles.",
    price: "$7.30",
    image: "/images/oreo-cream-cookie.png",
    rating: "4.9",
    label: "Most gifted",
